...
const PackageManageForm = () => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            const res = await axiosInstance.post('/auth/register-package', formDataToSend, {
    ...
    return (
        <div style={{ maxWidth: '500px', margin: 'auto', padding: '20px' }}>
            <h2>Package Manager Registration</h2>
...
export default PackageManageForm;
